"use strict";
// TODO - refactor this to core as this is part of state management
...
var utils = require('dapple-chain/lib/utils.js');
  ...
  var configNewConnection = (name) => {
    ...
    return inquirer.prompt([
      ...
      return new Promise(function(resolve, reject) {
        ...
        chain_expert.analyze(chaintypes, web3, (err, type, _genesis) => {
          genesis = _genesis;
      ...
      if(res.type === 'CUSTOM') {
        return inquirer.prompt([{
          type: 'input',
          name: 'chaintype',
          message: 'Name and save your new chaintype',
          default: 'CUSTOM'
        }]).then((name) => {
          if(name.chaintype === 'CUSTOM') {
            return res;
          } else {
            res.type = name.chaintype;
            // TODO - assert name not already taken
            // TODO - print genesis hash as chain id
            state._global_state.chaintypes[name.chaintype] = {genesis};
